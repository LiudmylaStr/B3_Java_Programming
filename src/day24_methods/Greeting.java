...
public class Greeting { public static void hello (String name) { // Parameterized method - meaning this method accepts parameter in the parenthesis -- >  String name = "Tom";
    // String name = "Tom";
